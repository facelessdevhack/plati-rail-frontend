export { default as InventoryLocationsPage } from './InventoryLocationsPage';
export { default as InventoryLocationDetailsPage } from './InventoryLocationDetailsPage';
export { default as InventoryMovementsPage } from './InventoryMovementsPage';
