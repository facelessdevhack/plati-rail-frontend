...
import { getDealerQuantity, getDealerQuantityBySize } from '../../redux/api/dashboardAPI'

const DealerMetricsDetailsBySize = () => {
    ...
    const { dealerQuantityMetricsBySize } = useSelector(state => state.metrics)

    const isAdmin = user.roleId === 5;

    // API CALLS
    useEffect(() => {
        dispatch(getDealerQuantityBySize({dealerId: id, page: currentPage, limit: pageSize, startDate, endDate}))
            ...
            <div className='p-5 h-full'>
                <div>
                        ...
                        <CustomTable
                            ...
                            data={dealerQuantityMetricsBySize}
                            titleOnTop={false}
...
export default DealerMetricsDetailsBySize